...
public class LongGoonEntity extends AnimalEntity {

    public static final double NORMAL_SPEED = 1.150;
    public static final double PANIC_SPEED = 1.5;

    public LongGoonEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return MobEntity.createMobAttributes()
                ...
                .add(EntityAttributes.GENERIC_MOVEMENT_SPEED, GlobalSpeed.fromRate(0.15))
    ...
    public PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.ENTITY_LONG_GOON.create(world);
    }
}
